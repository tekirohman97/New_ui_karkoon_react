  ...
  return (
    <View style={styles.boxNotif}>
      ...
      <TouchableOpacity style={styles.isiNotif}>
        ...
        <Text style={styles.textNotifeUserIsi}>Membalas Komentar Anda</Text>
        <View style={{flexDirection: 'row', alignItems: 'flex-end'}}>
          <Text style={styles.textNotifeUserIsi}>"Oalah gtu thanks infonya semoga.."</Text>
...
export default function Komentar_page() {
  return (
    <View style={{paddingHorizontal: 16, backgroundColor: ColorsStyle.whitee}}>
      <View style={styles.container2}>
        ...
        <Text style={styles.textHeader}>Komentar</Text>
      </View>
      <View>
        <Notif />
        <Notif />
