    ...
    return (
      <View style={styles.topHeader}>
        ...
        <View style={{paddingLeft: 20, flex: 1}}>
          <Text style={styless.textHeader}> Komentar</Text>
        </View>
      </View>
    );
  }
  ...
  render() {
    return (
      <View style={{paddingHorizontal: 16}}>
        <View
          ...
          <View style={{flex: 1, marginLeft: 8}}>
            ...
            <View
              ...
              <Text style={styles.textLinkKomen}>1 jam</Text>
              <Text style={styles.textLinkLike}>200 suka</Text>
              <TouchableOpacity style={{marginLeft: 12}}>
                <Text style={styles.textLinkKomen}>Balas</Text>
              </TouchableOpacity>
            </View>
          </View>
          <TouchableOpacity
        ...
        <TouchableOpacity style={{flexDirection: 'row', paddingLeft:40}}>
              <Text style={styles.textLinkKomen}>-------------</Text>
              <Text style={styles.textLinkLike}>Lihat 2 balasan</Text>
            </TouchableOpacity>
        <View
          style={{
            flexDirection: 'row',
