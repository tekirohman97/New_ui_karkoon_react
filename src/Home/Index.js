...
const AppNavigator =() =>{
  return(
    <Tab.Navigator initialRouteName='CrurrentOrders'
    ...
    tabBarOptions={{
        ...
        pressColor: '#fff',
        scrollEnabled: false,
        tabStyle: { backgroundColor: '#fff', borderRadius: 30,  justifyContent: 'center', alignContent: 'center' },
        indicatorStyle: { backgroundColor: '#F95454' },
        style: { backgroundColor: '#ffffff',  margin: 0, height: 52, width: '100%' },
